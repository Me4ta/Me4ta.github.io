...
TS.storage.setUp()
}TS.log(488,"TS.storage.disabled:"+TS.storage.disabled)
...
}}catch(b){}}TS.log(488,"TS.storage.disabled:"+TS.storage.disabled);
...
},oldest_ts_part:"oldest_msg_ts_",_makeOldestTsId:function(b){return TS.storage.oldest_ts_part+b
},fetchOldestTs:function(b){if(TS.boot_data.feature_oldest_msg_storing){return TS.storage._get(TS.storage._makeOldestTsId(b),null)
}return null
},storeOldestTs:function(c,b){if(TS.boot_data.feature_oldest_msg_storing){TS.storage._set(TS.storage._makeOldestTsId(c),b);
return
}TS.storage._set(TS.storage._makeOldestTsId(c),null)
...
},storeClientWindows:function(b){TS.storage._set("client_windows",b)
...
},storeChannelPageState:function(b){TS.storage._set("channel_page_state",b)
}});
